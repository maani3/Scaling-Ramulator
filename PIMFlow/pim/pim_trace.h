...
void OutputNewtonTraceV2BG(std::ostream& OS, std::string kernel_name, int64_t row, int64_t col, int64_t stride, StrideInfo sinfo=StrideInfo());
void OutputNewtonTraceV2scaled(std::ostream& OS, std::string kernel_name, int64_t row, int64_t col, int64_t stride, StrideInfo sinfo=StrideInfo());
}
