...
map<string, enum GDDR6::Speed> GDDR6::speed_map = {
    ...
    {"GDDR6_7000", GDDR6::Speed::GDDR6_7000},
};
...
void GDDR6::init_speed()
{
    ...
    switch (speed_entry.rate){
        case 3500: speed = 0; break;
        case 4000: speed = 1; break;
        case 4500: speed = 2; break;
        case 5000: speed = 3; break;
        case 5500: speed = 4; break;
        case 6000: speed = 5; break;
        case 6500: speed = 6; break;
        case 7000: speed = 7; break;
        default: assert(0);
    }
...
void GDDR6::init_lambda()
{
    ...
    lambda[int(Level::BankGroup)][int(Command::G_ACT0)] = [] (DRAM<GDDR6>* node, int id) {
        //id is row id
    ...
    lambda[int(Level::BankGroup)][int(Command::G_ACT4)] = lambda[int(Level::BankGroup)][int(Command::G_ACT0)];
    lambda[int(Level::BankGroup)][int(Command::G_ACT5)] = lambda[int(Level::BankGroup)][int(Command::G_ACT0)];
    lambda[int(Level::BankGroup)][int(Command::G_ACT6)] = lambda[int(Level::BankGroup)][int(Command::G_ACT0)];
    lambda[int(Level::BankGroup)][int(Command::G_ACT7)] = lambda[int(Level::BankGroup)][int(Command::G_ACT0)];
...
void GDDR6::init_timing()
{
    ...
    t[int(Command::GWRITE)].push_back({Command::G_ACT4, 1, c});
    t[int(Command::GWRITE)].push_back({Command::G_ACT5, 1, c});
    t[int(Command::GWRITE)].push_back({Command::G_ACT6, 1, c});
    t[int(Command::GWRITE)].push_back({Command::G_ACT7, 1, c});
    ...
    t[int(Command::G_ACT3)].push_back({Command::G_ACT4, 1, s.nFAW});
    t[int(Command::G_ACT4)].push_back({Command::G_ACT5, 1, s.nFAW});
    t[int(Command::G_ACT5)].push_back({Command::G_ACT6, 1, s.nFAW});
    t[int(Command::G_ACT6)].push_back({Command::G_ACT7, 1, s.nFAW});
    ...
    t[int(Command::G_ACT4)].push_back({Command::COMP, 1, s.nRCDR});
    t[int(Command::G_ACT5)].push_back({Command::COMP, 1, s.nRCDR});
    t[int(Command::G_ACT6)].push_back({Command::COMP, 1, s.nRCDR});
    t[int(Command::G_ACT7)].push_back({Command::COMP, 1, s.nRCDR});
    ...
    // t[int(Command::READRES)].push_back({Command::G_ACT2, 1, 6});
    // t[int(Command::READRES)].push_back({Command::G_ACT3, 1, 6});
    t[int(Command::READRES)].push_back({Command::GWRITE, 1, 6});
